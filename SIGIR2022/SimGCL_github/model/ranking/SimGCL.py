...
class SimGCL(GraphRecommender):
    ...
    def initModel(self):
        ...
        self.user_embeddings = tf.Variable(initializer([self.num_users, self.emb_size]), name='user_embeddings')
        self.item_embeddings = tf.Variable(initializer([self.num_items, self.emb_size]), name='item_embeddings')
