...
class AmazonMusicReader(_AmazonReviewDataReader):
    ...
    DATASET_URL_RATING = "https://snap.stanford.edu/data/amazon/productGraph/categoryFiles/ratings_Digital_Music.csv"
    DATASET_URL_METADATA = "https://snap.stanford.edu/data/amazon/productGraph/categoryFiles/meta_Digital_Music.json.gz"
