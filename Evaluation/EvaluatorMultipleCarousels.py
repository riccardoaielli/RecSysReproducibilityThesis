...
class EvaluatorMultipleCarousels(Evaluator):
    ...
    def _compute_metrics_on_recommendation_list(self, test_user_batch_array, recommended_items_batch_list, scores_batch, results_dict):
        ...
        for batch_user_index in range(len(recommended_items_batch_list)):
            ...
            results_current_cutoff[EvaluatorMetrics.ARHR.value]                 += arhr_all_hits(is_relevant_and_unique_current_cutoff)
            ...
            results_current_cutoff[EvaluatorMetrics.MAP_MIN_DEN.value].add_recommendations(is_relevant_and_unique_current_cutoff, relevant_items)
            results_current_cutoff[EvaluatorMetrics.HIT_RATE.value].add_recommendations(is_relevant_and_unique_current_cutoff)
