...
from WWW2022.FastVAE_our_interface.FastVAEDataReader import FastVAEDataReader
from WWW2022.FastVAE_our_interface.FastVAE_RecommenderWrapper import FastVAE_RecommenderWrapper
...
def run_this_algorithm_experiment(dataset_name,
    ...
    config['gamma'] = 0.95,  # discout for lr
    ...
    if flag_article_default:
        ...
        try:
            ...
            print("On recommender {} Exception {}".format(
                FastVAE_RecommenderWrapper, str(e)))
            traceback.print_exc()
    ...
    if flag_print_results:
        ...
        if dataset_name == 'ml10M':
            ...
            paper_results.loc[cutoff_to_optimize, 'RECALL'] = 0.5078

        elif dataset_name == "gowalla":
            paper_results.loc[cutoff_to_optimize, 'NDCG'] = 0.1797
            paper_results.loc[cutoff_to_optimize, 'RECALL'] = 0.2971

        else:
            paper_results = None

        reproduced_algorithm_list, base_algorithm_list = copy_reproduced_metadata_in_baseline_folder(FastVAE_RecommenderWrapper,
                                                                                                     this_model_folder_path,
...
if __name__ == '__main__':
    ...
    ALGORITHM_NAME = "FastVAE"
    CONFERENCE_NAME = "WWW2022"
